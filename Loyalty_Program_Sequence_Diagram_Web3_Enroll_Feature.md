...
sequenceDiagram
    ...
    participant WomAPI
    participant StellarSmartContract
    ...
    alt Consumer has already joined the program
        ...
        alt Consumer has already loyalty from this program
            ...
            WomAPI->>StellarSmartContract: Generate consumer wallet and Request for Mint NFT
            StellarSmartContract->>Customer: Transfer NFT to consumer wallet
            Customer->>StellarSmartContract: Notify mint and request for save consumer wallet informations
        end
    end
...
5. **NFT Wallet and Loyalty Card Creation**: The WOM API interacts with the StellarSmartContract to generate a consumer wallet and request to mint a loyalty card in the form of an NFT.
...
- **Consumer Wallets and NFTs**: Leveraging Stellar's blockchain technology, a consumer's wallet is created, and loyalty cards are issued as NFTs. This gives a digital and transferable representation of loyalty points or rewards.

- **Soroban Smart Contracts**: These contracts, written and deployed on the Stellar network, manage the logic for creating loyalty cards, handling the transfer of NFTs, and updating consumer information. Soroban provides the necessary tools and a robust environment to develop these smart contracts.
